...
class DPIA(models.Model): #DPIA is a process designed to help organizations identify and minimize the data protection risks of a project. It is particularly relevant when processing personal data that could impact the rights and freedoms of individuals.
    """Model representing a Data Protection Impact Assessment (DPIA)."""
    project_name = models.CharField(max_length=255)
    description = models.TextField()
    data_types = models.JSONField()  # Store as a list of strings ie types of personal data processed eg names, email addresses
    risks = models.JSONField()        # Store as a list of strings
...
class Incident(models.Model): #formal account of an event that has occurred, particularly those that involve data breaches or security incidents. This model helps organizations keep track of incidents and take appropriate action.from django.db import models
from authentication.models import Organization, User
from dotenv import load_dotenv
import os
import json
