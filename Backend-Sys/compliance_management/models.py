...
class DataProtectionRegulation(models.Model):
    __doc__ = "Model representing a data protection regulation."
...
class ComplianceReport(models.Model):
    __doc__ = "Model representing a compliance report generated for an organization."
...
class ComplianceDocument(models.Model):
    __doc__ = "Model representing a compliance document uploaded by an organization."
...
class DataProcessingActivity(models.Model):
    __doc__ = "Model representing a data processing activity conducted by an organization."
...
class DPIA(models.Model):
    __doc__ = "Model representing a Data Protection Impact Assessment (DPIA)."
...
class Incident(models.Model):
    __doc__ = "Model representing an incident report."
    description = models.TextField()
